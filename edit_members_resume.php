...
<body>
    ...
    {   	
		...
		{
		    if(empty($_POST['login']) AND empty($_POST['email']) AND empty($_POST['name']) AND empty($_POST['surname']) AND empty($_POST['password']) AND empty($_POST['privilege']) AND empty($_POST['niv_plongeur']) AND empty($_POST['niv_encadrant']) AND empty($_POST['certif_med']) AND empty($_POST['inscription_valide']) AND !isset($_POST['edit_member_id']) AND !isset($_POST['delete_member_id'])) // La page est vierge
		    {
