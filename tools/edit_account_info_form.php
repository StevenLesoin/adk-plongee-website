                ...
                <form class="col s12" action="edit_account_info.php" method="post">
                    <div class="row center">
                        <div class="input-field col s6">
                            ...
                            <input value="<?php echo $_SESSION['pseudo']; ?>" id="login" type="text" class="validate" name="login">
                            <!-- <label for="login">Pseudo</label> -->
                            <span class="helper-text">Pseudo</span>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">email</i>
                            <input value="<?php echo $_SESSION['email']; ?>" id="email" type="email" class="validate" name="email">
                            <!-- <label for="email">email</label> -->
                            <span class="helper-text">Email</span>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">account_box</i>
                            <input value="<?php echo $_SESSION['prenom']; ?>" id="surname" type="text" class="validate" name='surname'>
                            <!-- <label for="surname">Prénom</label> -->
                            <span class="helper-text">Prénom</span>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix">account_box</i>
                            <input value="<?php echo $_SESSION['nom']; ?>" id="name" type="text" class="validate" name='name'>
